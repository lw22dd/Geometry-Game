...
const CRYSTAL_CAVERNS_DATA: MapData = {
  ...
  layers: {
    ...
    objects: [
      ...
      /* —— 弹簧跳板 —— */
      { type: 'springPad', x: 5, y: 49, w: 2.5, h: 2, force: { x: 0, y: 96 }, duration: 0.3 },
      { type: 'springPad', x: 163, y: 49, w: 2.5, h: 2, force: { x: 0, y: 96 }, duration: 0.3 },
      { type: 'springPad', x: 85, y: 62, w: 2.5, h: 2, force: { x: 0, y: 110 }, duration: 0.3 },
      { type: 'springPad', x: 65, y: 4, w: 2.5, h: 2, force: { x: 0, y: 128 }, duration: 0.3 },
      { type: 'springPad', x: 112, y: 4, w: 2.5, h: 2, force: { x: 0, y: 128 }, duration: 0.3 },
      /* —— 激光栅栏 —— */
      { type: 'laser', x: 25, y0: 30, len: 5, ph: 0 },
      { type: 'laser', x: 150, y0: 30, len: 5, ph: 1.5 },
      { type: 'laser', x: 60, y0: 43, len: 4, ph: 0.8 },
      { type: 'laser', x: 120, y0: 43, len: 4, ph: 2.1 },
      { type: 'laser', x: 40, y0: 56, len: 4, ph: 1.2 },
      { type: 'laser', x: 135, y0: 56, len: 4, ph: 0.5 },
      /* —— 光球（沿路径散布） —— */
      { type: 'orb', x: 7, y: 10 },
      { type: 'orb', x: 22, y: 14 },
      { type: 'orb', x: 7, y: 18 },
