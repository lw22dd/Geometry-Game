...
const TYPE_NAMES: Record<string, string> = {
  ...
  laser: '激光栅栏', springPad: '弹簧跳板', hookPickup: '钩锁道具', shieldPickup: '护盾道具', speedPickup: '加速道具', track: '玻璃管道',
};
...
const TERRAIN_SEV: Record<string, 'error' | 'warn'> = {
  ...
  hookPickup: 'error', shieldPickup: 'error', speedPickup: 'error', track: 'warn',
};
