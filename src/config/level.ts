...
import {
  ...
  createSpringPad, createLaser, createSpike, createLoopTrack, createHookPickup,
...
export const maps: MapDefinition[] = [
  ...
  // ══════════════════════════════════════════════
  {
    ...
    floor: {
      gridSize: 1,
      cells: [
        { x: 0, y: 0, w: 42, h: 1, color: '#4c8dd8' },
        { x: 2, y: 1, w: 9, h: 1, color: '#4c8dd8' },
        { x: 16, y: 1, w: 1, h: 1, color: '#4c8dd8' },
        { x: 22, y: 1, w: 1, h: 1, color: '#4c8dd8' },
        { x: 27, y: 1, w: 1, h: 1, color: '#4c8dd8' },
        { x: 41, y: 1, w: 1, h: 1, color: '#4c8dd8' },
        { x: 5, y: 2, w: 6, h: 1, color: '#4c8dd8' },
        { x: 16, y: 2, w: 12, h: 1, color: '#4c8dd8' },
        { x: 35, y: 2, w: 7, h: 1, color: '#4c8dd8' },
        { x: 10, y: 3, w: 1, h: 1, color: '#4c8dd8' },
        { x: 16, y: 3, w: 1, h: 1, color: '#4c8dd8' },
        { x: 22, y: 3, w: 1, h: 1, color: '#4c8dd8' },
        { x: 27, y: 3, w: 1, h: 1, color: '#4c8dd8' },
        { x: 2, y: 4, w: 2, h: 2, color: '#4c8dd8' },
        { x: 22, y: 5, w: 1, h: 1, color: '#4c8dd8' },
        { x: 27, y: 5, w: 1, h: 1, color: '#4c8dd8' },
        { x: 41, y: 3, w: 1, h: 3, color: '#4c8dd8' },
        { x: 2, y: 6, w: 3, h: 1, color: '#4c8dd8' },
        { x: 6, y: 6, w: 1, h: 1, color: '#4c8dd8' },
        { x: 8, y: 6, w: 1, h: 1, color: '#4c8dd8' },
        { x: 10, y: 5, w: 1, h: 2, color: '#4c8dd8' },
        { x: 12, y: 6, w: 1, h: 1, color: '#4c8dd8' },
        { x: 14, y: 6, w: 1, h: 1, color: '#4c8dd8' },
        { x: 16, y: 5, w: 1, h: 2, color: '#4c8dd8' },
        { x: 27, y: 6, w: 3, h: 1, color: '#4c8dd8' },
        { x: 33, y: 6, w: 3, h: 1, color: '#4c8dd8' },
        { x: 40, y: 6, w: 2, h: 1, color: '#4c8dd8' },
        { x: 2, y: 8, w: 2, h: 1, color: '#4c8dd8' },
        { x: 16, y: 8, w: 1, h: 1, color: '#4c8dd8' },
        { x: 28, y: 8, w: 1, h: 1, color: '#4c8dd8' },
        { x: 41, y: 7, w: 1, h: 2, color: '#4c8dd8' },
        { x: 2, y: 9, w: 7, h: 1, color: '#4c8dd8' },
        { x: 10, y: 9, w: 9, h: 1, color: '#4c8dd8' },
        { x: 20, y: 9, w: 11, h: 1, color: '#4c8dd8' },
        { x: 32, y: 9, w: 5, h: 1, color: '#4c8dd8' },
        { x: 39, y: 9, w: 3, h: 1, color: '#4c8dd8' },
        { x: 2, y: 10, w: 3, h: 1, color: '#4c8dd8' },
        { x: 6, y: 10, w: 3, h: 1, color: '#4c8dd8' },
        { x: 10, y: 10, w: 2, h: 1, color: '#4c8dd8' },
        { x: 14, y: 10, w: 3, h: 1, color: '#4c8dd8' },
        { x: 27, y: 10, w: 1, h: 1, color: '#4c8dd8' },
        { x: 2, y: 11, w: 1, h: 1, color: '#4c8dd8' },
        { x: 41, y: 10, w: 1, h: 2, color: '#4c8dd8' },
        { x: 15, y: 11, w: 2, h: 2, color: '#4c8dd8' },
        { x: 28, y: 12, w: 1, h: 1, color: '#4c8dd8' },
        { x: 32, y: 12, w: 5, h: 1, color: '#4c8dd8' },
        { x: 39, y: 12, w: 3, h: 1, color: '#4c8dd8' },
        { x: 41, y: 13, w: 1, h: 2, color: '#4c8dd8' },
        { x: 16, y: 15, w: 1, h: 1, color: '#4c8dd8' },
        { x: 22, y: 15, w: 1, h: 1, color: '#4c8dd8' },
        { x: 35, y: 15, w: 2, h: 1, color: '#4c8dd8' },
        { x: 39, y: 15, w: 3, h: 1, color: '#4c8dd8' },
        { x: 2, y: 16, w: 1, h: 1, color: '#4c8dd8' },
        { x: 16, y: 16, w: 2, h: 1, color: '#4c8dd8' },
        { x: 19, y: 16, w: 5, h: 1, color: '#4c8dd8' },
        { x: 26, y: 16, w: 5, h: 1, color: '#4c8dd8' },
        { x: 32, y: 16, w: 3, h: 1, color: '#4c8dd8' },
        { x: 2, y: 17, w: 2, h: 1, color: '#4c8dd8' },
        { x: 30, y: 17, w: 1, h: 1, color: '#4c8dd8' },
        { x: 41, y: 16, w: 1, h: 3, color: '#4c8dd8' },
        { x: 0, y: 1, w: 1, h: 19, color: '#4c8dd8' },
        { x: 2, y: 19, w: 40, h: 1, color: '#4c8dd8' },
        { x: 0, y: 20, w: 42, h: 1, color: '#4c8dd8' },
      ],
    },
    ...
    hints: [
      ...
      [18, 18, "内有螺旋墙"],
      [24.5, 18, "内有三角墙"],
      [37.6818, 17.3636, "内有实心方块"],
      [9.3118, 13.8882, "内有大型拱门；传送点②"],
      [19.8333, 14.0417, "内有骷髅地标"],
      [20, 11, "玩家起点"],
      [31.3235, 11.0882, "内有实心方块"],
      [22.4412, 7.5882, "内有实心方块"],
      [31.7143, 7.7143, "传送点③"],
      [37.7941, 7.6176, "内有符文阵"],
      [13.3571, 4.0238, "内有拱形建筑"],
      [31.3621, 4.0172, "内有实心方块群"],
      [38, 4.5, "白格窗"],
      [1.6818, 10.3636, "电梯井，贯穿全图"],
    ],
