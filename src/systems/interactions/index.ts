 ...
 *   updateCollectSystem(tx, ty) / updateRespawnPointSystem(tx, ty, interact) / updateGoalSystem()
 *   updateJumpBoostSystem(tx, ty)
 */
...
export { updateJumpBoostSystem } from './JumpBoostSystem';
